...
```{r corbinplot, fig.height=8, fig.width=10, fig.cap = "Correlations between trait estimates based on a binomial model. Bold correlations are different from zero as judged by the 95\\% CrI.", out.width="100%"}
p_cor_bin
```
