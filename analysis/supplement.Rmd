...
All the data was collected by the same experimenter and where live-coded within the session. The experimenter was alone in the test room most of the time points; only rarely was a second person present to observe the experimenter (e.g., for training purposes or internships). It was always ensured that the presence of additional people did not affect the apes and, consequently, the test results.
