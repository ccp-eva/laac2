...
<!-- All data sets, model outputs and analysis code are available in the associated online [`repository`](https://github.com/ccp-eva/laac2/).  -->
All data sets, model outputs and analysis code are available in the associated online [*masked for peer review*]. The repository also contains additional documentation of the experiemental procedures and example videos for the different tasks.
...
Example videos for each task can be found in the associated online repository in [*masked for peer review*]. The tasks are presented in the order in which they were administered (see upplementary Figure \@ref(fig:setup)). 
