...
For this analysis, we also included data from the tasks (excluding the switching task) reported in @bohn2023great because they tested the same individuals. The following descriptions are verbatim copies from the supplementary material of @bohn2023great.
...
Supplementary Figure \@ref(fig:lseplotrasch) shows the latent state means and the person-separation reliability estimates for the latent state variables. The patterns of change in the latent state means are comparable to the SEM results, even though the Rasch-based estimates seem more variable [Manuel, was genau meinst du damit?]. The reliability estimates are higher compared to the SEM approach, however, please note that they have a different interpretation. 
