...
```{r lseplotrasch, fig.height = 3, fig.width=8, fig.cap = "Latent means and reliability estimates with 95\\% CrI for each time point based on Rasch-model.", out.width="100%"}
plsm_rasch
```
