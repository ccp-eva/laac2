...
All data files and analysis scripts can be found in the associated online repository [masked for peer review]. The supplementary material provides additional details on the statistical analysis and the results. In the following, we limit ourselves to describing only the key analysis and results. 
